 ...
 * Date: 2025-02-22
 * Description: Implementation of the Redis RPUSH function for IBM i.
 *              Pushes a value to the tail of a Redis list.
...
/**********************************************************************/
/* SQL External Function: RPUSH */
/**********************************************************************/

void SQL_API_FN rpushRedisList(
	...
	SQLUDF_NULLIND *nullind)
{
	...
	*resultInd = 0;
	...
	// Build RPUSH command: "*3\r\n$5\r\nRPUSH\r\n$<key_len>\r\n<key>\r\n$<value_len>\r\n<value>\r\n"
	strcat(ebcdic_send_buf, "\x5C\xF3\x0D\x25\x5B\xF5\x0D\x25\xD9\xD7\xE4\xE2\xC8\x0D\x25"); // *3\r\n$5\r\nRPUSH\r\n
...
#pragma linkage(rpushRedisList, OS)
