 ...
 * Date: 2025-02-22
 * Description: Implementation of the Redis INCR function for IBM i.
 *              This function increments a value in a Redis server using a key.
...
/**
 * Function: incrRedisValue
 * Description: SQL external function to increment a value in Redis using a key.
 * Parameters:
 ...
 */
void SQL_API_FN incrRedisValue(
    ...
    SQLUDF_NULLIND *nullind)  // Additional null indicators for DB2SQL
{
    ...
    *valueInd = 0;
    ...
    // Format Redis INCR command in EBCDIC
    ebcdic_send_buf[0] = '\0';
    ...
    // Build INCR command in EBCDIC: "*2\r\n$4\r\nINCR\r\n$<key_len>\r\n<key>\r\n"
    strcat(ebcdic_send_buf, "\x5C\xF2\x0D\x25\x5B\xF4\x0D\x25\xC9\xD5\xC3\xD9\x0D\x25"); // EBCDIC "*2\r\n$4\r\nINCR\r\n"
    ...
    // Convert EBCDIC INCR command to ASCII before sending
    ascii_send_buf[0] = '\0';
...
#pragma linkage(incrRedisValue, OS)