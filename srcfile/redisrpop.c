 ...
 * Date: 2025-02-22
 * Description: Implementation of the Redis RPOP function for IBM i.
...
/**********************************************************************/
/* SQL External Function: RPOP */
/**********************************************************************/

void SQL_API_FN rpopRedisList(
    ...
    SQLUDF_NULLIND *nullind)
{
    ...
    *valueInd = 0;
    ...
    // Build RPOP command: "*2\r\n$4\r\nRPOP\r\n$<key_len>\r\n<key>\r\n"
    strcat(ebcdic_send_buf, "\x5C\xF2\x0D\x25\x5B\xF4\x0D\x25\xD9\xD7\xD6\xD7\x0D\x25"); // *2\r\n$4\r\nRPOP\r\n
...
#pragma linkage(rpopRedisList, OS)
