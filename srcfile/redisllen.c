 ...
 * Date: 2025-02-22
 * Description: Implementation of the Redis LLEN function for IBM i.
...
/**********************************************************************/
/* SQL External Function: LLEN */
/**********************************************************************/

void SQL_API_FN llenRedisList(
    SQLUDF_VARCHAR *key,      // Input: Redis key (VARCHAR(255), EBCDIC)
    SQLUDF_BIGINT *value,     // Output: list length (BIGINT)
    ...
    SQLUDF_NULLIND *nullind)  // Additional null indicators for DB2SQL
{
    ...
    *valueInd = 0;
    ...
    // Format Redis LLEN command in EBCDIC
    ebcdic_send_buf[0] = '\0';
    ...
    // Build LLEN command: "*2\r\n$4\r\nLLEN\r\n$<key_len>\r\n<key>\r\n"
    strcat(ebcdic_send_buf, "\x5C\xF2\x0D\x25\x5B\xF4\x0D\x25\xD3\xD3\xC5\xD5\x0D\x25"); // *2\r\n$4\r\nLLEN\r\n
...
#pragma linkage(llenRedisList, OS)
